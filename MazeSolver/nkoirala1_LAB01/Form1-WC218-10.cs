...
namespace nkoirala1_LAB01
{
    public partial class Form1 : Form
    {
        ...
        private int scale = 10; //Scale for the cDrawer
        ...
        private void Solve()
        {
            ...
            while (pointsToExplore.Count > 0 && solving)
            {
                ...
                if (current == end)
                {
                    _lbStatus.Invoke((Action)(() => _lbStatus.Items.Add("Solve: Success - Maze solved!")));
                    solving = false;
        ...
        private void SolveWithThreading()
        {
            ...
            while (pointsToExplore.Count > 0 && solving)
            {
                ...
                if (current == end)
                {
                    Invoke((Action)(() => _lbStatus.Items.Add("SolveWithThreading: Success - Maze solved!")));
                    solving = false;
                    Invoke((Action)(() => _btnSolve.Enabled = false));
        ...
        private void LoadMaze(string _filename)
        {
            try
            {
                ...
                _btnSolve.Enabled = true; // Enable the Solve button
